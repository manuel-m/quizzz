(function () {
  ...
  const UA = inBrowser$1 && window.navigator.userAgent.toLowerCase();
  ...
  // detect devtools
  const devtools = inBrowser$1 && window.__VUE_DEVTOOLS_GLOBAL_HOOK__;
  ...
  const hasTransition = inBrowser$1 && !isIE9;
  ...
  const shouldDecodeNewlines = inBrowser$1 ? getShouldDecode(false) : false;
  // #6828: chrome encodes content in a[href]
  const shouldDecodeNewlinesForHref = inBrowser$1 ? getShouldDecode(true) : false;
  ...
  const hdr = {
    template: `
  <div class="bg-blue-500 text-gray-50 p-3 shadow-md flex space-x-8">
